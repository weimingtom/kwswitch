...
/*Table structure for table `kw_switch` */
...
/*Data for the table `kw_switch` */

insert  into `kw_switch`(`device_id`,`device_name`,`api_key`,`state`,`sensor`,`category`,`update_time`,`create_time`,`user_id`,`user_name`,`remark`,`del_flg`,`switch_a`,`switch_b`) values (1,'智能浇灌','A432594C7B234966B0CC4D24E57','0','temperature','single_switch','2020-05-20 20:01:41','2020-05-19 10:35:17',1,'管理员','双路继电器控制LED灯','0','0','0'),(2,'双路电灯开关','B432594C7B234966B0CC4D24E57','0','temperature','double_switch','2020-05-19 10:22:56','2020-05-19 10:22:56',1,'管理员','双路继电器控制LED灯','0','1','0'),(3,'卧室灯','D432594C7B234966B0CC4D24E57','1','temperature','single_switch','2020-09-05 10:05:57','2020-05-19 10:22:57',1,'admin','控制卧室灯的单路开关0','0','0','0');
...
insert  into `qrtz_scheduler_state`(`sched_name`,`instance_name`,`last_checkin_time`,`checkin_interval`) values ('RuoyiScheduler','WIN-KKFPM1D249P1633034444381',1633034943277,15000);
...
insert  into `qrtz_triggers`(`sched_name`,`trigger_name`,`trigger_group`,`job_name`,`job_group`,`description`,`next_fire_time`,`prev_fire_time`,`priority`,`trigger_state`,`trigger_type`,`start_time`,`end_time`,`calendar_name`,`misfire_instr`,`job_data`) values ('RuoyiScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1633034450000,-1,5,'PAUSED','CRON',1633034444000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1633034445000,-1,5,'PAUSED','CRON',1633034444000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1633034460000,-1,5,'PAUSED','CRON',1633034444000,0,NULL,2,'');
